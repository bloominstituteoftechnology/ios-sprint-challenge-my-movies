...
class MyMoviesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    lazy var fetchResultsController: NSFetchedResultsController<Movie> = {
        ...
        let sortedByTitle = NSSortDescriptor(key: "title", ascending: true)
        let sortedByWatched = NSSortDescriptor(key: "hasWatched", ascending: true)
        
        fetchRequest.sortDescriptors = [sortedByWatched, sortedByTitle]
