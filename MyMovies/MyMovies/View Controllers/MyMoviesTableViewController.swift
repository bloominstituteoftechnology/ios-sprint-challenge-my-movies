...
class MyMoviesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "MyMovieCell", for: indexPath) as? MyMoviesTableViewCell else { fatalError("Unable to dequeue cell") }
            ...
            movieController.deleteMovieFromServer(movie) { (error) in
                ...
                DispatchQueue.main.async {
                    ...
                    do {
                        ...
                        moc.reset()
                        NSLog("Error saving managed object to context: \(error)")
                    }
                }
            }
