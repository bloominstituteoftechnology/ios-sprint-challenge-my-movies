...
class MyMoviesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        ...
        if sectionInfo.name == "1" {
            sectionName = "Seen movies"
        } else {
            sectionName = "Unseen movies"
        }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as? MyMoviesTableViewCell else {return UITableViewCell()}
...
extension MyMoviesTableViewController: ChangeSeenDelegate {
    func movieSeenChange(_ item: Movie) {
        
        movieController.updater(movie: item)
