...
class MyMoviesTableViewController: UITableViewController {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController<Movie> = {
        ...
        do {
            ...
            print("Error fetching Movies from fetchedResultsController")
        }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let deletedMovie = fetchedResultsController.object(at: indexPath)
            movieContoller.deleteCoreDataMovie(movie: deletedMovie)
        }
    }
...
//MARK: - Extensions
extension MyMoviesTableViewController: MovieWasSeenDelegate {
    func movieWasWatched(movie: Movie) {
        movieContoller.movieWasWatched(movie: movie)
    }
}
