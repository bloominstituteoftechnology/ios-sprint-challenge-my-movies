...
class MyMoviesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "MyMovieCell", for: indexPath) as? MovieListTableViewCell else { return UITableViewCell() }
...
//MARK: - Extension
extension MyMoviesTableViewController: MovieListTableViewCellDelegate {
