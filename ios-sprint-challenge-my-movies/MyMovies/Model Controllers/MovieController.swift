...
class MovieController {
    ...
    private let firebaseURL = URL(string: "https://mymovies-7a926.firebaseio.com/")!
    ...
    // MARK: - MyMovies Firebase API
    
    func fetchSavedMovieFromServer(completion: @escaping CompletionHandler = { _ in }) {
